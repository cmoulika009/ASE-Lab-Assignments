...
.factory('fireBaseData', function($firebase) {
    ...
    refCart = new Firebase("https://my-first-project-68e3c.firebaseio.com/cart"),
    refUser = new Firebase("https://my-first-project-68e3c.firebaseio.com/users"),
    refCategory = new Firebase("https://my-first-project-68e3c.firebaseio.com/category"),
    refOrder = new Firebase("https://my-first-project-68e3c.firebaseio.com/orders"),
    refFeatured = new Firebase("https://my-first-project-68e3c.firebaseio.com/featured"),
    refMenu = new Firebase("https://my-first-project-68e3c.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
